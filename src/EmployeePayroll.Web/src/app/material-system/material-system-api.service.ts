...
import { MaterialGridResponse, MaterialInvoiceUploadResponse } from '../models';
...
export class MaterialSystemApiService {
  ...
  getGrid(
    ...
    vendor?: string,
    project?: string
  ): Observable<MaterialGridResponse> {
    ...
    return this.http.get<MaterialGridResponse>(`${this.base}/api/material-system/grid`, { params });
  }
  ...
  uploadInvoice(
    ...
    month: number,
    year: number
  ): Observable<MaterialInvoiceUploadResponse> {
    ...
    const params = new HttpParams()
      ...
      .set('month', month)
      .set('year', year);
    return this.http.post<MaterialInvoiceUploadResponse>(`${this.base}/api/material-system/upload`, form, { params });
  }
